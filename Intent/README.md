...
1. Write the JSON schema describing your resource, `customresource-lex-intent.json`
2. Implement your resource handlers in `customresource_lex_intent/handlers.py`
