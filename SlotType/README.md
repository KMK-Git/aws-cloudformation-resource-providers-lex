...
1. Write the JSON schema describing your resource, `customresource-lex-slottype.json`
2. Implement your resource handlers in `customresource_lex_slottype/handlers.py`
